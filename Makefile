...
# Lightweight PS3 Homebrew SDK
	...
	CFLAGS += -DIOAPI_NO_64 -D__PS3__
	CXXFLAGS += -DIOAPI_NO_64 -D__PS3__
	STATIC_LINKING = 1
	ifeq ($(platform), psl1ght)
		CFLAGS += -D__PSL1GHT__
		CXXFLAGS += -D__PSL1GHT__
	endif
...
# XYDDS
	...
	LDFLAGS += -shared -Wl,--version-script=link.T
	fpic := -fPIC
	CFLAGS += -O2 -marm -mfpu=neon-vfpv4 -mfloat-abi=hard -DARM -mcpu=cortex-a7
	CXXFLAGS += -O2 -marm -mfpu=neon-vfpv4 -mfloat-abi=hard -DARM -mcpu=cortex-a7
